...
func (c *CacheFSEngine) transform(runtime *datav1alpha1.CacheFSRuntime) (value *CacheFS, err error) {
	...
	err = c.transformMaster(runtime, value)
	if err != nil {
		return
	}
...
func (c *CacheFSEngine) transformWorkers(runtime *datav1alpha1.CacheFSRuntime, dataset *datav1alpha1.Dataset, value *CacheFS) (err error) {
	...
	value.Image, value.ImageTag, value.ImagePullPolicy, err = c.parseCacheFSImage(false, image, imageTag, imagePullPolicy)
	if err != nil {
		return
	}
	...
	err = c.transformWorkerVolumes(runtime, value, mount)
	if err != nil {
