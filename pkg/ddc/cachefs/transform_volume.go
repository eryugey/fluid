...
func (c *CacheFSEngine) transformWorkerVolumes(runtime *datav1alpha1.CacheFSRuntime, value *CacheFS, mount datav1alpha1.Mount) (err error) {
	sourceTyp, pvcName, subpath, err := ParseSubPathFromMountPoint(mount.MountPoint)
	if err != nil {
		return err
	}
	...
	case SourceTypePvc:
		...
		value.ImportSource = DataSourceMountPath + subpath
	case SourceTypeLocal:
		...
		value.Worker.Volumes = append(value.Worker.Volumes, volume)
		value.ImportSource = DataSourceMountPath
	}
...
func (c *CacheFSEngine) transformWorkerCacheVolumes(runtime *datav1alpha1.CacheFSRuntime, value *CacheFS) (err error) {
	cacheDir := ""
	...
	// set tiredstore cache as volume as well, for clear cache when shut down
...
func (c *CacheFSEngine) transformFuseVolumes(runtime *datav1alpha1.CacheFSRuntime, value *CacheFS) (err error) {
...
// after genValue & genMount function
func (c *CacheFSEngine) transformFuseCacheVolumes(runtime *datav1alpha1.CacheFSRuntime, value *CacheFS) (err error) {
	cacheDir := ""
...
func (c *CacheFSEngine) transformMasterVolumes(runtime *datav1alpha1.CacheFSRuntime, value *CacheFS) (err error) {
