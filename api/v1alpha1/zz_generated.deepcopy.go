...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CacheFSCompSpec) DeepCopyInto(out *CacheFSCompSpec) {
	*out = *in
	if in.Ports != nil {
		in, out := &in.Ports, &out.Ports
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CacheFSCompSpec.
func (in *CacheFSCompSpec) DeepCopy() *CacheFSCompSpec {
	if in == nil {
		return nil
	}
	out := new(CacheFSCompSpec)
	in.DeepCopyInto(out)
	return out
}
