...
func schema_fluid_cloudnative_fluid_api_v1alpha1_CacheFSRuntimeSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"importDataset": {
						SchemaProps: spec.SchemaProps{
							Description: "Dataset used as CacheFS source",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"configs": {
						SchemaProps: spec.SchemaProps{
							Description: "Configs of CacheFS, options for cachefs format sub-command, e.g. [\"storage=oss\", \"capacity=100\"]",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/fluid-cloudnative/fluid/api/v1alpha1.CacheFSCompSpec", "github.com/fluid-cloudnative/fluid/api/v1alpha1.CacheFSFuseSpec", "github.com/fluid-cloudnative/fluid/api/v1alpha1.PodMetadata", "github.com/fluid-cloudnative/fluid/api/v1alpha1.TieredStore", "github.com/fluid-cloudnative/fluid/api/v1alpha1.User", "github.com/fluid-cloudnative/fluid/api/v1alpha1.VersionSpec", "k8s.io/api/core/v1.Volume"},
	}
}
